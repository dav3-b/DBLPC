...
class Logger:
    ...
    def _write_params(self, params: dict, l_params: dict, log_params: dict, train: bool) -> None:
        """
    ...
    def _get_metrics(self, params: dict, train: bool) -> list[str]:
        """
    ...
    def _add_rows(self, vals: list[list]) -> None:
        """
    ...
    def save_model(self, weights: NDArray[np.float64]):
        """
        Save the qtable.
        """
    ...
    def load_model(self) -> NDArray[np.float64]:
        """
        Load the qtable.
        """
    ...
    def save_computation_time(self, computation_time: datetime.timedelta, train=True) -> None:
        """
